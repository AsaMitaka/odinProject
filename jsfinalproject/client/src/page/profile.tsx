        ...
        <main className="col-span-3 p-3">
          <div className=" px-5 bg-black text-white">
            ...
            <div className="flex justify-between">
              <div className="px-10 py-3 border-b border-blue-600 cursor-pointer hover:bg-gray-600">
                Tweets
              </div>
              <div className="px-10 py-3 text-gray-400 cursor-pointer hover:bg-gray-600">
                Replies
              </div>
              <div className="px-10 py-3 text-gray-400 cursor-pointer hover:bg-gray-600">Likes</div>
            </div>
          </div>
          <section>
            <Tweet />
